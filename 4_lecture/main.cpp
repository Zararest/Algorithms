...
int main(int argc, char **argv) {
    ...
    if (argc > 1 && argv[1] == string("ascend")) {//отсортированный
        kind = "ascend";
        argc--; argv++;
    }
    if (argc > 1 && argv[1] == string("descend")) {//отсортированный обратно
        kind = "descend";
        argc--; argv++;
    }
    int start_alg = 0;
    if (argc > 1 && argv[1] == string("fastest")) {//нормальные сортировки
       argc--; argv++;
       start_alg = 5;
    }
    int n = 100000;
